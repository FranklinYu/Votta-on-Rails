...
+SECRET_KEY_BASE+ should be bytes (over 30 bytes, typically 128 bytes) in
hexadecimal form. Now migrate the database:
...
The easiest way to use Docker[https://www.docker.com/] is
{Docker Compose}[https://docs.docker.com/compose/]. Docker 1.12.0 or above, and
Docker-Compose 1.6.0 or above, are required. Concerning the environment
...
or specified in {environment file}[https://docs.docker.com/compose/env-file/]
